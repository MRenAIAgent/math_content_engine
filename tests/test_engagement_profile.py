...
class TestEngagementProfileDict:
    """Test EngagementProfile creation via create_engagement_profile()."""
    ...
    def test_has_student_false_by_default(self):
        ep = create_engagement_profile()
        assert has_student(ep) is False

    def test_has_student_true_with_name(self):
        ep = create_engagement_profile(address="Jordan", student_name="Jordan")
        assert has_student(ep) is True

    def test_mutability(self):
        """Dicts can be mutated — unlike the old frozen dataclass."""
        ep = create_engagement_profile()
        ep["address"] = "mutated"
        assert ep["address"] == "mutated"
    ...
    def test_overrides(self):
        ...
        assert ep["color_palette"] == "BLUE, RED"

    def test_unknown_keys_ignored(self):
        ep = create_engagement_profile(unknown_field="ignored")
        assert "unknown_field" not in ep
